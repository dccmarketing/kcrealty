...
if ( ! function_exists( 'kcrealty_posted_on' ) ) :
/**
...
if ( ! function_exists( 'kcrealty_entry_footer' ) ) :
/**
 * Prints HTML with meta information for the categories, tags and comments.
 *
 * @uses 	get_post_type()
 * @uses 	get_the_category_list()
 * @uses 	kcrealty_categorized_blog()
 ...
 * @uses 	edit_post_link()
 */
	function kcrealty_entry_footer() {
		...
		if ( 'post' == get_post_type() ) {
			...
			if ( $categories_list && kcrealty_categorized_blog() ) {
 ...
 * @return bool
 */
function kcrealty_categorized_blog() {

	if ( false === ( $all_the_cool_cats = get_transient( 'kcrealty_categories' ) ) ) {
		...
		set_transient( 'kcrealty_categories', $all_the_cool_cats );

	}

	if ( $all_the_cool_cats > 1 ) {

		// This blog has more than 1 category so kcrealty_categorized_blog should return true.
		return true;

	} else {

		// This blog has only 1 category so kcrealty_categorized_blog should return false.
		return false;

	}

} // kcrealty_categorized_blog()

/**
 * Flush out the transients used in kcrealty_categorized_blog.
 *
 * @uses 	delete_transient()
 */
function kcrealty_category_transient_flusher() {

	if ( defined( 'DOING_AUTOSAVE' ) && DOING_AUTOSAVE ) { return; }

	// Like, beat it. Dig?
	delete_transient( 'kcrealty_categories' );

} // kcrealty_category_transient_flusher()
add_action( 'edit_category', 'kcrealty_category_transient_flusher' );
add_action( 'save_post',     'kcrealty_category_transient_flusher' );
